<?php
/*
Plugin Name: 壹刻图床上传插件
Plugin URI: https://ekimg.cn
Description: 免费公共图床, 提供图片上传和图片外链服务, 原图保存, 隐私相册, 全球CDN加速.
Author: 小黙
Author URI: https://ekimg.cn
Version: 1.0
 */
...
class hidoveimage
{
    ...
    {
        $trs = array(
            'plugin_name' => '壹刻图床图片上传插件',
            'plugin_uri' => 'https://ekimg.cn',
            'description' => '壹刻图床图片上传插件。上传您的图片至壹刻图床，并在您的站点中显示。',
            'author_uri' => 'https://ekimg.cn',
        );
        if ($key) {
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<p>详细说明：<a href="https://ekimg.cn" target="_blank">https://ekimg.cn</a></p>
						</td>
					</tr>
					<tr>
						<th scope="row">反馈和技术支持：</th>
						<td>
							<p>E-Mail:admin@ekimg.cn</p>
